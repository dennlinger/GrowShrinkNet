...
### MNIST
## batch size
#python main.py --data vMNIST --model gsCNN --gpu 1 --kernels 7 --kernelg 3 --num_filters 8 --batch_size 64
#python main.py --data vMNIST --model gsCNN --gpu 1 --kernels 7 --kernelg 3 --num_filters 8 --batch_size 128
#
## filters
#python main.py --data vMNIST --model gsCNN --gpu 1 --kernels 7 --kernelg 3 --num_filters 16 --batch_size 64
#python main.py --data vMNIST --model gsCNN --gpu 1 --kernels 7 --kernelg 3 --num_filters 16 --batch_size 128
#
#
### Fashion-MNIST
## batch size
#python main.py --data vFashion --model gsCNN --gpu 1 --kernels 7 --kernelg 3 --num_filters 8 --batch_size 64
#python main.py --data vFashion --model gsCNN --gpu 1 --kernels 7 --kernelg 3 --num_filters 8 --batch_size 128
#
## filters
#python main.py --data vFashion --model gsCNN --gpu 1 --kernels 7 --kernelg 3 --num_filters 16 --batch_size 64
#python main.py --data vFashion --model gsCNN --gpu 1 --kernels 7 --kernelg 3 --num_filters 16 --batch_size 128

### gmsCNN
## MNIST
# batch size
python main.py --data vMNIST --model gmsCNN --gpu 1 --kernels 7 --kernelg 3 --kernel 5 --num_filters 8 --batch_size 64
python main.py --data vMNIST --model gmsCNN --gpu 1 --kernels 7 --kernelg 3 --kernel 5 --num_filters 8 --batch_size 128

# filters
python main.py --data vMNIST --model gmsCNN --gpu 1 --kernels 7 --kernelg 3 --kernel 5 --num_filters 16 --batch_size 64
python main.py --data vMNIST --model gmsCNN --gpu 1 --kernels 7 --kernelg 3 --kernel 5 --num_filters 16 --batch_size 128


## Fashion-MNIST
# batch size
python main.py --data vFashion --model gmsCNN --gpu 1 --kernels 7 --kernelg 3 --kernel 5 --num_filters 8 --batch_size 64
python main.py --data vFashion --model gmsCNN --gpu 1 --kernels 7 --kernelg 3 --kernel 5 --num_filters 8 --batch_size 128

# filters
python main.py --data vFashion --model gmsCNN --gpu 1 --kernels 7 --kernelg 3 --kernel 5 --num_filters 16 --batch_size 64
python main.py --data vFashion --model gmsCNN --gpu 1 --kernels 7 --kernelg 3 --kernel 5 --num_filters 16 --batch_size 128